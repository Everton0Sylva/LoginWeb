...
namespace LoginWeb.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                string userNameTrim = userName.Replace(" ", "");
                var user = new IdentityUser { UserName = userNameTrim.ToLower(), Email = Input.Email };
